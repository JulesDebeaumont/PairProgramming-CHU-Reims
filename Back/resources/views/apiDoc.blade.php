...
<body class="antialiased bg-[#0E162A]">
    <div class="p-10">
        <h1 class="text-4xl font-bold text-neutral-200 pl-3 my-6 pb-5 text-center">
            Pair Programming API
        </h1>
        <h2 class="text-2xl font-bold text-neutral-200 mb-4 pl-3">
